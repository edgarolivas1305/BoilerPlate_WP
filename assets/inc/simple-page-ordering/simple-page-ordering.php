...
class Simple_Page_Ordering {
	...
	public static function wp() {
		...
		if ( ( is_string( $orderby ) && 0 === strpos( $orderby, 'menu_order' ) ) || ( isset( $orderby['menu_order'] ) && $orderby['menu_order'] == 'ASC' ) ) {
			...
			wp_enqueue_script( 'simple-page-ordering', get_template_directory_uri() . '/inc/simple-page-ordering/' . $script_name, array('jquery-ui-sortable'), '2.1', true );
			wp_enqueue_style( 'simple-page-ordering', get_template_directory_uri() . '/inc/simple-page-ordering/simple-page-ordering.css' );
		}
	}
